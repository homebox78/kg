...
<html lang="ko">
    ...
    ?>
    <?php
        echo '<script src="'.run_replace('head_css_url', G5_THEME_JS_URL.'/scripts.bundle.js?ver='.G5_CSS_VER, G5_THEME_URL).'">"></script>'.PHP_EOL;
    ?>
</head>

<!--Body-->
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?> id="kt_app_body" data-kt-app-layout="light-header" data-kt-app-header-fixed="true" data-kt-app-toolbar-enabled="true" class="app-default">
